                                     ...
                                     <tbody>
                                         @foreach ($timetables as $timetable)
                                             <tr>
                                                 ...
                                                 <td>{{ \Carbon\Carbon::createFromFormat('H:i', $timetable->start_time)->format('h:i A') }}
                                                 </td>
                                                 <td>{{ \Carbon\Carbon::createFromFormat('H:i', $timetable->end_time)->format('h:i A') }}
                                                 </td>
                                                 <td>{{ $timetable->room_no }}</td>
                                                 <td><a href="{{ route('time-table.delete', $timetable->id) }}"
 ...
 @section('customJs')
     ...
     <script>
         ...
         $('#class_id').change(function() {
             ...
             $.ajax({
                 url: "{{ route('time-table.findSubject') }}",
                 type: "GET",
                 data: {
                     class_id: class_id
                 },
