                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <textarea name="message" id="message" cols="30" rows="3"
                                            class="form-control @error('message') is-invalid @enderror" placeholder="Write your announcement">{{ old('message') }}</textarea>
                                        @error('message')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <Select class="form-control @error('type') is-invalid @enderror" name="type">
                                            ...
                                            <option value="parent" {{ old('type') == 'parent' ? 'selected' : '' }}>Parents
                                            </option>
                                        </Select>
                                        @error('type')
                                            <p class="invalid-feedback">{{ $message }}</p>
